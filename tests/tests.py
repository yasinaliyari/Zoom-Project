...
class TestAll(TestCase):
    ...
    def test_login_success_redirect(self):
        ...
        response = self.client.post(
            reverse("login"), data={"username": "test1", "password": "test1pass"}
        )
    ...
    def test_login_failed_redirect(self):
        ...
        response = self.client.post(
            reverse("login"), data={"username": "test1", "password": "pass"}
        )
        self.assertEqual(response["Location"], bar_path)
    ...
    def test_signup(self):
        response = self.client.post(
            ...
            data={
                "username": "sajjad",
                "email": "Sajjad123@gmail.com",
                "password1": "Farahan123",
                "password2": "Farahan123",
            },
        )
        try:
    ...
    def test_join_or_create_team1(self):
        ...
        account.save()
        team = Team.objects.create(name="dishdish", zoom_url="dishdish")
        account.team = team
        account.save()
    ...
    def test_join_or_create_team2(self):
        ...
        try:
            ...
            self.assertEqual(1, 2)
        if team.zoom_url != "http://meet.jit.si/filan":
